...
<!-- ./wrapper -->
                ...
                <div class="chat-logs">
                    <div class="chat-msg user">
                        <div class="d-flex align-items-center">
                            <span class="msg-avatar">
                                <img src="<?=$base_url?>/assets/images/avatar/2.jpg" class="avatar avatar-lg">
                            </span>
                            <div class="mx-10">
                    ...
                    <div class="chat-msg self">
                        <div class="d-flex align-items-center justify-content-end">
                            ...
                            <span class="msg-avatar">
                                <img src="<?=$base_url?>/assets/images/avatar/3.jpg" class="avatar avatar-lg">
                            </span>
                        </div>
                        <div class="cm-msg-text">
	...
	<script src="<?=$base_url?>/assets/cdn.amcharts.com/lib/5/xy.js"></script>
	<script src="<?=$base_url?>/assets/cdn.amcharts.com/lib/5/themes/Animated.js"></script>

	<script src="<?=$base_url?>/assets/vendor_components/jquery-knob/js/jquery.knob.js"></script>

	<!-- DataTables JS -->
    <script src="<?=$base_url?>/assets/cdn.datatables.net/1.13.6/js/jquery.dataTables.min.js"></script>

	
	<!-- Coup Admin App -->
	<script src="<?=$base_url?>/assets/js/demo.js"></script>
	<script src="<?=$base_url?>/assets/js/template.js"></script>
	<script src="<?=$base_url?>/assets/js/pages/widget-blog.js"></script>
	<script src="<?=$base_url?>/assets/js/pages/dashboard2.js"></script>
	<script src="<?=$base_url?>/assets/js/pages/invoice.js"></script>
